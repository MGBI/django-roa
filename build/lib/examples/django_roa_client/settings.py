...
ROA_URL_OVERRIDES_LIST = {
    'django_roa_client.remotepagewithoverriddenurls': 'http://127.0.0.1:8081/django_roa_server/remotepagewithoverriddenurls/',
}
ROA_URL_OVERRIDES_DETAIL = {
    'django_roa_client.remotepagewithoverriddenurls': lambda o: "%s%s-%s/" % (o.get_resource_url_list(), o.id, o.slug),
}
